...
A recommended implementation is to run this off a Raspberry-pi, as it’s useful for portability and low power consumption. (but most any host system can perform this, it only uses a basic shell, lynx, sed, grep, cut, dygraphs, and a scheduler)
<p>
